...
ICECLOUD_SLICE = os.path.join(Ice.getSliceDir(), 'IceCloud', 'ServerFactory.ice')
if not os.path.exists(ICECLOUD_SLICE):
    ICECLOUD_SLICE = os.path.join(os.path.dirname(__file__), 'ServerFactory.ice')


Ice.loadSlice('-I. --all {}'.format(ICECLOUD_SLICE))
